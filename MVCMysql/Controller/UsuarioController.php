...
class UsuarioController{
    ...
    public function cadastrar(){
        ...
        header('Location: /PHP_PBE_2IDS_2025/MVCMysql/usuario/telaCadastro');
        exit;
    }
    ...
    public function atualizar(){
        ...
        header('Location: /PHP_PBE_2IDS_2025/MVCMysql/usuario/telaEditar?id='.($_GET['id']));
        exit;
    }

    public function excluir(){
        Usuario::excluir($_GET['id']);
        header('Location: /PHP_PBE_2IDS_2025/MVCMysql/usuario/listar');
        exit;
    }
}